...
def prefunction_balance_tx(tx_public):
     ...
     #tx_public = '1F2DKvmGkjJsyJ8jt65jrdEZoj8qkj6rCg'
...
def total_bitcoin_data(data):

 size = len(data)
 max_supply = 21000000
 bitcoins_circulation = data['Bitcoins in circulation'][size-1]
 total_percentage = (bitcoins_circulation * 100) / max_supply  
 
 print('Max supply : ' ,max_supply) 
 print('------')
 print('Bitcoin in circulation : ' , bitcoins_circulation)
 print('------')
 print('Total emited percentage : ' , round(total_percentage,2),'%')
